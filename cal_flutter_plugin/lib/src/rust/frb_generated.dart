...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 828526276;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<ProviderImplConfig> crateApiCryptoCreateWithKvConfig({
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  TaskConstMeta get kCryptoLayerCommonErrorCalErrorBacktraceConstMeta =>
      const TaskConstMeta(debugName: "CalError_backtrace", argNames: ["that"]);
  ...
  TaskConstMeta get kCryptoLayerCommonErrorCalErrorErrorKindConstMeta =>
      const TaskConstMeta(debugName: "CalError_error_kind", argNames: ["that"]);
  ...
  TaskConstMeta get kCryptoLayerCommonDhExchangeIdConstMeta =>
      const TaskConstMeta(debugName: "DhExchange_id", argNames: ["that"]);
  ...
  TaskConstMeta get kCryptoLayerCommonKeyHandleDeleteConstMeta =>
      const TaskConstMeta(debugName: "KeyHandle_delete", argNames: ["that"]);
  ...
  TaskConstMeta get kCryptoLayerCommonKeyHandleIdConstMeta =>
      const TaskConstMeta(debugName: "KeyHandle_id", argNames: ["that"]);
  ...
  TaskConstMeta get kCryptoLayerCommonKeyHandleSpecConstMeta =>
      const TaskConstMeta(debugName: "KeyHandle_spec", argNames: ["that"]);
  ...
  TaskConstMeta get kCryptoLayerCommonKeyPairHandleIdConstMeta =>
      const TaskConstMeta(debugName: "KeyPairHandle_id", argNames: ["that"]);
  ...
  TaskConstMeta get kCryptoLayerCommonKeyPairHandleSpecConstMeta =>
      const TaskConstMeta(debugName: "KeyPairHandle_spec", argNames: ["that"]);
  ...
  get kCryptoLayerCommonCryptoAlgorithmsKeyDerivationArgon2OptionsDefaultConstMeta =>
      const TaskConstMeta(debugName: "argon_2_options_default", argNames: []);
  ...
  get kCryptoLayerCommonCryptoAlgorithmsEncryptionCipherDefaultConstMeta =>
      const TaskConstMeta(debugName: "cipher_default", argNames: []);
  ...
  Future<ProviderImplConfig> crateApiCryptoCreateWithKvConfig({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiCryptoCreateWithKvConfigConstMeta,
  ...
  TaskConstMeta get kCrateApiCryptoCreateWithKvConfigConstMeta =>
      const TaskConstMeta(
        debugName: "createWithKVConfig",
        argNames: [
          "getFn",
          "storeFn",
          "deleteFn",
  ...
  get kCryptoLayerCommonCryptoAlgorithmsHashesCryptoHashDefaultConstMeta =>
      const TaskConstMeta(debugName: "crypto_hash_default", argNames: []);
  ...
  TaskConstMeta get kCryptoLayerCommonFactoryGetAllProvidersConstMeta =>
      const TaskConstMeta(debugName: "get_all_providers", argNames: []);
  ...
  get kCryptoLayerCommonCryptoAlgorithmsKeyDerivationKdfDefaultConstMeta =>
      const TaskConstMeta(debugName: "kdf_default", argNames: []);
  ...
  TaskConstMeta get kCryptoLayerCommonConfigKeyPairSpecDefaultConstMeta =>
      const TaskConstMeta(debugName: "key_pair_spec_default", argNames: []);
  ...
  TaskConstMeta get kCryptoLayerCommonConfigKeySpecDefaultConstMeta =>
      const TaskConstMeta(debugName: "key_spec_default", argNames: []);
  ...
  get kCryptoLayerCommonCryptoPkcsStandardsOidTypeAsStrConstMeta =>
      const TaskConstMeta(debugName: "oid_type_as_str", argNames: ["that"]);
  ...
  KDF dco_decode_kdf(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return KDF_Argon2d(dco_decode_box_autoadd_argon_2_options(raw[1]));
      case 1:
        return KDF_Argon2id(dco_decode_box_autoadd_argon_2_options(raw[1]));
      case 2:
        return KDF_Argon2i(dco_decode_box_autoadd_argon_2_options(raw[1]));
      default:
        throw Exception("unreachable");
    }
  }
  ...
  (String, ProviderConfig) dco_decode_record_string_provider_config(
    ...
    return (dco_decode_String(arr[0]), dco_decode_provider_config(arr[1]));
  }
  ...
  (String, Spec) dco_decode_record_string_spec(dynamic raw) {
    ...
    return (dco_decode_String(arr[0]), dco_decode_spec(arr[1]));
  }
  ...
  Spec dco_decode_spec(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return Spec_KeySpec(dco_decode_box_autoadd_key_spec(raw[1]));
      case 1:
        return Spec_KeyPairSpec(dco_decode_box_autoadd_key_pair_spec(raw[1]));
      default:
        throw Exception("unreachable");
    }
  }
  ...
  ProviderConfig sse_decode_provider_config(SseDeserializer deserializer) {
    ...
    var var_supportedAsymSpec = sse_decode_Set_asymmetric_key_spec_None(
      deserializer,
    );
    return ProviderConfig(
  ...
  void
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerArcdynFnStringDynFutureOptionVecu8SendSync(
    ArcFnStringDynFutureOptionVecU8 self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as ArcFnStringDynFutureOptionVecU8Impl).frbInternalSseEncode(
        move: true,
      ),
      serializer,
    );
  ...
  void
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerArcdynFnStringPinBoxdynFutureOutputSendSendSync(
    ArcFnStringPinBoxFutureOutput self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as ArcFnStringPinBoxFutureOutputImpl).frbInternalSseEncode(
        move: true,
      ),
      serializer,
    );
  ...
  void
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerArcdynFnStringVecu8DynFutureboolSendSync(
    ArcFnStringVecU8DynFutureBool self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as ArcFnStringVecU8DynFutureBoolImpl).frbInternalSseEncode(
        move: true,
      ),
      serializer,
    );
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerCalError(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as CalErrorImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerDHExchange(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as DhExchangeImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerKeyHandle(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as KeyHandleImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_Auto_RefMut_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerDHExchange(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as DhExchangeImpl).frbInternalSseEncode(move: false),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerCalError(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as CalErrorImpl).frbInternalSseEncode(move: false),
      serializer,
    );
  }
  ...
  sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerKeyHandle(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as KeyHandleImpl).frbInternalSseEncode(move: false),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerCalError(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as CalErrorImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerDHExchange(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as DhExchangeImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerKeyHandle(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as KeyHandleImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
  ...
  void sse_encode_list_record_string_provider_config(
    List<(String, ProviderConfig)> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
...
class ArcFnDynFutureVecStringImpl extends RustOpaque
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_increment_strong_count_ArcFnDynFutureVecString,
    rustArcDecrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_ArcFnDynFutureVecString,
...
class CalErrorImpl extends RustOpaque implements CalError {
  ...
  Future<String> backtrace() =>
      RustLib.instance.api.cryptoLayerCommonErrorCalErrorBacktrace(that: this);

  Future<CalErrorKind> errorKind() =>
      RustLib.instance.api.cryptoLayerCommonErrorCalErrorErrorKind(that: this);
}
...
class ProviderImpl extends RustOpaque implements Provider {
  ...
  Future<Uint8List> hash({
    required List<int> input,
    required CryptoHash hash,
  }) => RustLib.instance.api.cryptoLayerCommonProviderHash(
    that: this,
    input: input,
    hash: hash,
  );
