...
/// pki_standard = PkiStandards::Pkcs(PkcsType::Pkcs1);
/// ```
///
...
///
/// pki_standard = PkiStandards::X509(X509Type::Certificate);
/// ```
///
/// # Note
///
...
///
/// x509_type = X509Type::Certificate;
/// ```
///
/// # Note
///
...
///
/// oid = ObjectIdentifiers::Oid(OidType::RsaEncryption);
/// ```
///
/// # Note
///
